...
public class BeanMapperVaryingClassTypesTest {

    @Test
    public void sourceHasDifferentAccessorClassTypes() {
    ...
    @Test
    public void listHasNoFieldProperty() {
    ...
    @Test
    public void listFromStringToLongToString() {
        SourceWithList source = new SourceWithList();
        source.list.add("42");
    ...
    @Test
    public void targetListMustBeUntouched() {
        SourceWithList source = new SourceWithList();
