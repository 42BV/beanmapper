...
public class CoreConfiguration implements Configuration {
    ...
    private final Map<Class<?>, Object> customDefaultsForClassMap = new HashMap<>();

    private final Map<Field, Object> customDefaultForFieldMap = new HashMap<>();
    ...
    public <T, V> void addCustomDefaultValueForClass(Class<T> targetClass, V value) {
        this.customDefaultsForClassMap.put(targetClass, value);
    }
    ...
    public <V> void addDefaultValueForField(Field field, V value) {
        this.customDefaultForFieldMap.put(field, value);
    }
    ...
    public <V> V getDefaultValueForField(Field field) {
        var value = this.customDefaultForFieldMap.get(field);
        return value == null ? this.getDefaultValueForClass(field.getType()) : (V) value;
    }
}
